...
-- ----------------------------
-- 清理：移除"系统工具"、"若依官网"菜单及其所有子菜单
-- ----------------------------
delete from sys_role_menu where menu_id in (1055, 1056, 1057, 1058, 1059, 1060, 115, 116, 117, 3, 4);
delete from sys_menu where menu_id in (1055, 1056, 1057, 1058, 1059, 1060);
delete from sys_menu where menu_id in (115, 116, 117);
delete from sys_menu where menu_id in (3, 4);